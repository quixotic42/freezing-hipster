...
public class BinarySearchGamee {
    ...
    public static void timingTests() throws FileNotFoundException {
        String[] smallWords = readFileSorted("url.txt", 256);
        timingTest(smallWords);
        
        System.out.println();

//        String[] mediumWords = readFileSorted("url.txt", 22082);
//        timingTest(mediumWords);
//        
//        System.out.println();
//
//        String[] largeWords = readFileSorted("url.txt", 985725);
...
//This sample code has red errors -- may not be good to use.
